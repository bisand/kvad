...
//!
//! Two architectures — [`model::GpuLlama`] and [`gpt2::GpuGpt2`] — each
...
//!
//! [`common`] holds what they share. That is a smaller list than it looks: two
//! weight layouts behind one `forward`, an embedding table that is dense or
